...
exports.generateGeoJsonDocRadius = function (documentSrc, radiusTarget, lat, lng) {
    var docReturn;
    if (documentSrc !== undefined &&
        documentSrc.name !== undefined &&
        documentSrc.type !== undefined &&
        radiusTarget !== undefined &&
        lat !== undefined &&
        lng !== undefined) {
...
exports.retirerWaypointTropProche = function (documentSrc, nbDecimalTolere) {
    ...
    if (documentSrc !== undefined && nbDecimalTolere !== undefined && documentSrc.features !== undefined) {
        ...
        for (iCpt = 0; iCpt < length; iCpt = iCpt + 1) {
            if (documentSrc.features[iCpt].geometry !== undefined &&
                documentSrc.features[iCpt].geometry.coordinates !== undefined &&
                !isNaN(documentSrc.features[iCpt].geometry.coordinates[0]) &&
                !isNaN(documentSrc.features[iCpt].geometry.coordinates[1])) {
